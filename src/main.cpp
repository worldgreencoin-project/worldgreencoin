...
#if defined(NDEBUG)
# error "WorldGreenCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "WorldGreenCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 86400; // 24 hours | 24 * 60 * 60
...
void ThreadScriptCheck() {
    RenameThread("worldgreencoin-scriptch");
...
bool AcceptBlock(CBlock& block, CValidationState& state, CDiskBlockPos* dbp)
{
    ...
    if (hash != Params().HashGenesisBlock()) {
        ...
        // WorldGreenCoin did not enable this BIP 34
        // TBD
        /*
        if (block.nVersion >= 3)
        {
