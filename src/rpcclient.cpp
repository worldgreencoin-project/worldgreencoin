...
std::string HelpMessageCli(bool mainProgram)
{
    ...
    strUsage += "  -rpcport=<port>        " + _("Connect to JSON-RPC on <port> (default: 15843 or testnet: 16843)") + "\n";
    ...
    if(mainProgram)
    {
        ...
        strUsage += "\n" + _("SSL options: (see the WorldGreenCoin Wiki for SSL setup instructions)") + "\n";
