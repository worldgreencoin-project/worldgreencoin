    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = tr("WorldGreenCoin Core");
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The WorldGreenCoin Core developers"));
