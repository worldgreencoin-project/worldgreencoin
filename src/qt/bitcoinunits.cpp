...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("WGC");
    case mBTC: return QString("mWGC");
    case uBTC: return QString::fromUtf8("μWGC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("WorldGreenCoins");
    case mBTC: return QString("Milli-WorldGreenCoins (1 / 1,000)");
    case uBTC: return QString("Micro-WorldGreenCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
