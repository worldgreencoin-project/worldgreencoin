    ...
    ui(new Ui::AboutDialog)
{
    ...
    tr("Copyright") + QString(" &copy; 2014-%1 ").arg(COPYRIGHT_YEAR) + tr("The WorldGreenCoin Core developers")
        );
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("WorldGreenCoin Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  worldgreencoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("WorldGreenCoin Core is shutting down...") + "<br /><br />" +
